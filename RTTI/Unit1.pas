...
begin
  ...
  //para qualquer item criado é necessario ter uma referencia (ex: TFormClass) para criar o objeto, se não, estoura exceção.
...
begin
  ...
  if (TClasse <> nil) then //and TClasse.InheritsFrom(TForm) then
  begin
////    Result := TClasse.NewInstance as TTeste; // Não precisa da definicao class of (TESTE = class of TTeste;) mas não funciona com construtor com parametros
